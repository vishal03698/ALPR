...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='/home/ezio/Documents/ALPR/config/yolov3.cfg', help='*.cfg path')
    parser.add_argument('--data', type=str, default='/home/ezio/Documents/ALPR/config/coco.data', help='*.data path')
    parser.add_argument('--weights', type=str, default='/home/ezio/Documents/ALPR/config/yolov3_1000.weights', help='weights path')
